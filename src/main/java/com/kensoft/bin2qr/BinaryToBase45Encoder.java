...
/**
 * See https://stackoverflow.com/questions/37996101/storing-binary-data-in-qr-codes
 * 
...
public class BinaryToBase45Encoder {
     ...
     */
    public static final int LONG_USABLE_BYTES = 7;//Long.BYTES - 1;
    ...
    public static final Map<Integer, Integer> BASE45_TO_BINARY_DIGIT_COUNT_CONVERSION = new HashMap<Integer, Integer>();
    ...
    public static byte[] decodeBase45QrPayload(final InputStream in) throws IOException {
        ...
        while(in.available() > 0) {
            ...
            final LinkedList<Byte> outputChunkBuffer = new LinkedList<Byte>();
